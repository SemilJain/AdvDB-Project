...
//     class BPlusTreeRWLock : public StoredsBase {
//     public:
//         BPlusTreeRWLock(const char *path) {
//             BPlusTreeRWLock::init(path);
//         }
...
//      */
//     int BPlusTreeRWLock::init(const char *path) {
//         root = NULL;
//         B = BPLUSTREE_DEGREE;
//         return 1;
//     }
...
//      */
//     int BPlusTreeRWLock::scan(const uint64_t key, int len, std::vector <std::vector<DB::Kuint64VstrPair>> &result) {
...
//      */
//     int BPlusTreeRWLock::read(const uint64_t key, void *&result) {
//         bool res = query(key);
//         result = (void *) res;
//         return 1;
//     }
...
//      */
//     int BPlusTreeRWLock::update(const uint64_t key, void *value) {
//         remove(key);
//         return 1;
//     }
...
//      */
//     int BPlusTreeRWLock::insert(const uint64_t key, void *value) {
//         insert1(key, key);
