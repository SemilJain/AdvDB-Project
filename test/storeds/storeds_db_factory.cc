...
#include "bplustree/bplustree_rwlock.cc"
#include "bplustree/bplustree_occ.cc"
#include "bplustree/bplustree_nolocks.cc"
#include "bplustree/bplustree_rcu.cc"
...
StoredsBase *StoredsDbFactory::GetDB(const char *type, const char *path) {
    ...
    // } else if (strcmp(type, "bplustree-rwlock") == 0) {
    //     return new BPlusTreeRWLock(path);
    // } else if (strcmp(type, "bplustree-occ") == 0) {
    //     return new BPlusTreeOCC(path);
    } else if (strcmp(type, "bplustree-nolock") == 0) {
        return new BPlusTreeNoLock(path);
    // } else if (strcmp(type, "bplustree-rcu") == 0) {
    //     return new BPlusTreeRCU(path);
